...
async function initializeApp() {
    ...
    function loadGoogleMaps() {
        ...
        return new Promise((resolve, reject) => {
            ...
            script.src = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyBEa4UhlC_Fy5RRNcdSq9PTC-PdVZ3H55U';
